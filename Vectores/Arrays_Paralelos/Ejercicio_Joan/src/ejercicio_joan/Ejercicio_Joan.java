...
public class ejercicio_Joan {
    ...
    public static void main(String[] args) {
        ...
        String[] Apellidos = new String[3];      //MISMO TAMAÑO
        ...
        while (!end) {
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    escribirApellidosDeMujeres(Apellidos, Sexo);
                    escribirNotasPepe(Nombre, Notas1rExamen);
                    break;
                case 5:
                    end = true;
                    break;
    ...
    //Ejercicio Grupo A
    public static void escribirTodosNombresMenoresDeEdad(String[] Nombre, boolean[] MayorEdad) {
    ...
    //Ejercicio Grupo B  
    public static void escribirApellidosDeMujeres(String[] Apellidos, char[] Sexo) {
    ...
    //Ejercicio Grupo C
    public static void escribirNotasPepe(String[] Nombre, float[] notas1rExamen) {
        for (int i = 0; i < Nombre.length; i++) {
            if (Nombre[i].equalsIgnoreCase("pepe")) {
                System.out.println(notas1rExamen[i]);
            }
